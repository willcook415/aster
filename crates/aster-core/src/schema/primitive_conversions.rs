...
impl From<AsterError> for AsterErrorDtoV1 {
    fn from(error: AsterError) -> Self {
        match error {
            ...
            AsterError::CrossingOrderRequiresMatching => Self::CrossingOrderRequiresMatching,
            AsterError::MarketOrderRequiresMatching => Self::MarketOrderRequiresMatching,
            AsterError::CancellationNotImplemented => Self::CancellationNotImplemented,
...
impl From<AsterErrorDtoV1> for AsterError {
    fn from(error: AsterErrorDtoV1) -> Self {
        match error {
            ...
            AsterErrorDtoV1::CrossingOrderRequiresMatching => Self::CrossingOrderRequiresMatching,
            AsterErrorDtoV1::MarketOrderRequiresMatching => Self::MarketOrderRequiresMatching,
            AsterErrorDtoV1::CancellationNotImplemented => Self::CancellationNotImplemented,
